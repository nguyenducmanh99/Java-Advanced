...
VALUE			('hanh.havan',			'123456',		'Hà',			'Văn Hanh',			'EMPLOYEE'	), 
				('thanhhung12',			'123456',		'Nguyễn ',		'Thanh Hưng',		'EMPLOYEE'	), 
				('can.tuananh',			'123456',		'Cấn',			'Tuấn Anh',			'EMPLOYEE'	), 
				('toananh123',			'123456',		'Nguyễn',		'Anh Toàn',			'EMPLOYEE'	), 
				('duynn03',				'123456',		'Nguyễn',		'Duy',				'EMPLOYEE'	), 
				('manhhung123',			'123456',		'Nguyễn',		'Mạnh Hùng',		'EMPLOYEE'	),
				...
				('nguyenducmanh',	    'm123456',		'Nguyễn',		'duc manh',			'ADMIN'		),
				('vananhvti',			'123456',		'Nguyễn',		'Vân Anh',			'EMPLOYEE'	),
				('ducmanhvti',			'm123456',		'Nguyễn',		'Duc Manh',		    'MANAGER'	),
